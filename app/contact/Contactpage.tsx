...
//     { id: "club", text: "Safety Bridge LTD" },
// ];
...
// const contacts = [
//     { id: "email", icons: Mail, text: "" },
//     { id: "voice", icons: Phone, text: "Voice Call Line: " },
//     { id: "whatsapp", icons: MessageCircle, text: "WhatsApp Line: " },
//     { id: "address", icons: MapPin, text: "Office:" },
// ];
...
//     return (
//         <main className="min-h-screen bg-gradient-to-br from-gray-900/5 to-black/10 text-gray-100">
