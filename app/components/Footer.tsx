...
export default function Footer() {
    ...
    return (
        <footer className="bg-gradient-to-br from-[#001845] via-[#001133] to-[#000818] text-white">
            <div className="max-w-8xl mx-auto px-6 md:px-8 lg:px-12 py-16">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
                    ...
                    <div>
                        ...
                        <form onSubmit={handleSubscribe} className="mb-8">
                            <div className="flex items-center bg-white/10 rounded-lg overflow-hidden border border-white/20 focus-within:border-blue-400 transition-colors">
                                ...
                                <button
                                    type="submit"
                                    className="px-4 py-3 hover:bg-blue-500/20 transition-colors"
                            ...
                            {footerData.socialMedia.map((social) => {
                                ...
                                return (
                                    <Link
                                        ...
                                        className="w-12 h-12 rounded-full bg-white flex items-center justify-center hover:bg-blue-500 transition-all duration-300 group"
                                        aria-label={social.name}
                                    >
                                        <FontAwesomeIcon
                                            icon={social.icon}
                                            className="w-5 h-5 text-[#001845] group-hover:text-white transition-colors" />
                                    </Link>
                                );
                            })}
                        </div>
            ...
            <div className="border-t border-white/10">
                <div className="max-w-7xl mx-auto px-6 md:px-8 lg:px-12 py-6">
                    <p className="text-center text-gray-400 text-sm">
                        ...
                        <span className="text-white font-semibold">Safety Bridge Limited®</span>.
                    </p>
                </div>
            </div>
        </footer>
